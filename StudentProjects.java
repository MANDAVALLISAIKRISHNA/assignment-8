...
public class StudentProjects {
    public static void main(String[] args) {
        ...
        projects.add(new Project("Krish", 5));
        projects.add(new Project("Sai", 7));
        projects.add(new Project("Sanjay", 3));
        projects.add(new Project("Babu", 6));
        projects.add(new Project("Daniel", 8));
